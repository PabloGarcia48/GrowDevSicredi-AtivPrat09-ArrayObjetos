...
document.write(`Média ${aluno1.nome} = ${mediaAluno1} (notas: ${aluno1.nota1} e ${aluno1.nota2})<br>`);
document.write(`Média ${aluno2.nome} = ${mediaAluno2} (notas: ${aluno2.nota1} e ${aluno2.nota2})<br>`);
document.write(`Média da turma = ${mediaTurma}`);
